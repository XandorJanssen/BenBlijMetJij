...
<div class="jumbotron p-4 p-md-5 text-white rounded header-test2 boven-aanpassing shadow-sm">
    <div class="col-md-8 px-0 ">
        <h1 class="display-4 fancy">Behandelingen</h1>
    </div>
</div>
...
<div class="card shadow-sm">
    <div class="card-body">
        ...
        <p>
            ...
            Omdat kinderen nog niet de vaardigheid hebben hun gevoelens in woorden uit te drukken, komen deze in
        ...
        <p>
            Bij het lezen van een tekening wordt er ook gekeken naar de totstandkoming van een tekening, hoe er getekend
            wordt.
            Het zegt veel over een persoon en daarom vinden wij het ook belangrijk als wij erbij zijn als er getekend
            wordt.
        </p>

        <p>
            Opmerking: De enige die (onbewust) weet wat er werkelijk met een tekening bedoeld wordt, is de tekenaar
            zelf.
        ...
        <p>
            ...
            toegepast.
            Denk maar eens aan een kind dat zijn knie stoot en zelf of een volwassene er automatisch over heen wrijft om
        ...
        <p>
            ...
            Fysiek gezien zorgt elke massage voor een betere doorbloeding.
            Massage is gericht op het afvoeren van spanning en het loslaten van opgeslagen emoties.
            Zo kan weer een natuurlijk herstel van de energiebalans in het lichaam plaatsvinden.
            Je wordt je bewuster van jezelf en dat is goed voor je persoonlijke ontwikkeling.
            Om de werking te verdiepen en de massage te veraangenamen wordt de massage gecombineerd met
            <a href="#Aromatherapie">aromatherapie</a>.
        </p>
        <p>
            Door chakra’s te balanceren door middel van massage of <a href="#Magnetiseren">magnetiseren</a> kunnen de
            lichamelijke
