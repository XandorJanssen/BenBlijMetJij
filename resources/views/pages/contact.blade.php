  ...
  <div class="col-md-6">
    ...
    <form>
      ...
      <div class="form-group">
          ...
          <textarea class="form-control" id="inputMessage" placeholder="Type hier uw bericht" rows="12"></textarea>
      </div>
      ...
      <div class="card mb-4 shadow-sm">
          ...
          'markers' => [
              [
                  ...
                  'lat' => 51.585730,
                  'lng' => 5.350840,
                  'popup' => '<h5>Ben Blij Met Jij</h5><p>De Volder 9, 5283 ZA, Boxtel</p>',
              ],
          ],
      ])      
